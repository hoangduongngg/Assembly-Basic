...
SINH_SUCO proc
    ...
    mov bl,10  ;mod cho 2 de lay 0 hoac 1
...
sinhSuco:  
    ...
    mov si, offset SUCO0   ; tuong duong lea si,suco0
    add si,ax 
    mov ax,[si]
...
tuyen1: 
    ...
    or  TT,ax
    mov ax,turnRED0    ; turnRED0 DW 1111_1111_1111_1001b 
    and TT,ax
    jmp ketthuc_batden_tuyen1
    DENDOX1:
...
Xanh_5          DW          0000_0000_0010_0000b
Xanh_B5         DW          0000_1000_0010_0000b    ;den xanh 5
...
WAITT PROC
        ...
        cmp ax,0   ; neu ko co thi bat den xanh.
        je RED_GREEN  
